...
const CompaniesCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            ...
            companyMail: _entity.companyMail
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="companies-create-dialog-component">
                <div>
                    <p className="m-0" >CompanyID:</p>
                ...
                <div>
                    <p className="m-0" >company Mail:</p>
                    <InputText className="w-full mb-3" value={_entity?.companyMail} onChange={(e) => setValByKey("companyMail", e.target.value)}  />
                </div>
...
export default connect(null, mapDispatch)(CompaniesCreateDialogComponent);
